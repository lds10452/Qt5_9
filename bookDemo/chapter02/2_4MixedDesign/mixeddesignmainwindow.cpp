#include "mixeddesignmainwindow.h"
#include "ui_mixeddesignmainwindow.h"
...
MixedDesignMainWindow::MixedDesignMainWindow(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::MixedDesignMainWindow)
{
    ui->setupUi(this);
...
MixedDesignMainWindow::~MixedDesignMainWindow()
{
    delete ui;
}
void MixedDesignMainWindow::updateCurFile(QString aFile)
{//更新当前文件名，并更新状态栏提示
    fCurFileName=aFile;
    fLabCurFile->setText("当前文件："+fCurFileName);
}

void MixedDesignMainWindow::iniUI()
{
//状态栏
...
void MixedDesignMainWindow::iniSignalSlots()
...
void MixedDesignMainWindow::on_txtEdit_copyAvailable(bool b)
...
void MixedDesignMainWindow::on_actOpen_triggered()
{
...
void MixedDesignMainWindow::on_actFont_triggered()
{
    bool    ok;
...
void MixedDesignMainWindow::on_actNew_triggered()
{//新建文件
    ui->txtEdit->clear();
    updateCurFile("");
}

void MixedDesignMainWindow::on_spinBoxFontSize_valueChanged(int aFontSize)
{//改变字体大小的SpinBox的响应
    QTextCharFormat fmt;
...
void MixedDesignMainWindow::on_comboFont_currentIndexChanged(const QString &arg1)
...
void MixedDesignMainWindow::on_actToolbarLab_triggered(bool checked)
{
    if (checked)  //显示文字和图标
...
void MixedDesignMainWindow::on_actFontBold_triggered(bool checked)
{
...
void MixedDesignMainWindow::on_actFontItalic_triggered(bool checked)
{
    QTextCharFormat fmt;
...
void MixedDesignMainWindow::on_actFontUnder_triggered(bool checked)
{
    QTextCharFormat fmt;
    fmt=ui->txtEdit->currentCharFormat();
...
void MixedDesignMainWindow::on_txtEdit_selectionChanged()
