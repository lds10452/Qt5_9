#include "StandardDialogsDialog.h"
#include "ui_StandardDialogsDialog.h"
...
StandardDialogsDialog::StandardDialogsDialog(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::StandardDialogsDialog)
{
    ui->setupUi(this);
}

StandardDialogsDialog::~StandardDialogsDialog()
{
    delete ui;
}

void StandardDialogsDialog::on_btnOpen_clicked()
{ //选择单个文件
...
void StandardDialogsDialog::on_btnClearText_clicked()
{
    ui->plainTextEdit->clear();
}

void StandardDialogsDialog::on_btnOpenMulti_clicked()
{ //选择多个文件
//  QString curPath=QCoreApplication::applicationDirPath(); //获取应用程序的路径
    QString curPath=QDir::currentPath();//获取系统当前目录
...
void StandardDialogsDialog::on_btnSelDir_clicked()
{ //选择文件夹
    QString curPath=QCoreApplication::applicationDirPath(); //获取应用程序的路径
//  QString curPath=QDir::currentPath();//获取系统当前目录
//调用打开文件对话框打开一个文件
...
void StandardDialogsDialog::on_btnSave_clicked()
{//保存文件
    QString curPath=QCoreApplication::applicationDirPath(); //获取应用程序的路径
...
void StandardDialogsDialog::on_btnColor_clicked()
{
...
void StandardDialogsDialog::on_btnFont_clicked()
{//选择字体
...
void StandardDialogsDialog::on_btnInputString_clicked()
{ //输入字符串
...
void StandardDialogsDialog::on_btnInputInt_clicked()
{//输入整数
...
void StandardDialogsDialog::on_btnInputFloat_clicked()
{ //输入浮点数
...
void StandardDialogsDialog::on_btnInputItem_clicked()
{ //条目选择输入
...
void StandardDialogsDialog::on_btnMsgQuestion_clicked()
{
...
void StandardDialogsDialog::on_btnMsgInformation_clicked()
{
...
void StandardDialogsDialog::on_btnMsgWarning_clicked()
{
...
void StandardDialogsDialog::on_btnMsgCritical_clicked()
{
...
void StandardDialogsDialog::on_btnMsgAbout_clicked()
{
...
void StandardDialogsDialog::on_btnMsgAboutQt_clicked()
{
