#ifndef CUSTOMDIALOGSMAINWINDOW_H
#define CUSTOMDIALOGSMAINWINDOW_H
...
namespace Ui {
class CustomDialogsMainWindow;
}

class CustomDialogsMainWindow : public QMainWindow
{
    Q_OBJECT
private:
...
public:
    explicit CustomDialogsMainWindow(QWidget *parent = nullptr);
    ~CustomDialogsMainWindow();
...
private:
    Ui::CustomDialogsMainWindow *ui;
};

#endif // CUSTOMDIALOGSMAINWINDOW_H
