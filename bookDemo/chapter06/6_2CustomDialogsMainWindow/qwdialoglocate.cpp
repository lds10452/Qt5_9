...
{ //窗口关闭事件，关闭时释放本窗口
    CustomDialogsMainWindow *parWind = (CustomDialogsMainWindow*)parentWidget(); //获取父窗口指针
...
{//窗口显示事件
    CustomDialogsMainWindow *parWind = (CustomDialogsMainWindow*)parentWidget();//获取
...
{//定位到单元格，并设置字符串
    ...
    CustomDialogsMainWindow *parWind = (CustomDialogsMainWindow*)parentWidget(); //获取主窗口
