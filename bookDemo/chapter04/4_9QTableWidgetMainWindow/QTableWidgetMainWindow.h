#ifndef QTABLEWIDGETMAINWINDOW_H
#define QTABLEWIDGETMAINWINDOW_H
...
namespace Ui {
class QTableWidgetMainWindow;
}

class QTableWidgetMainWindow : public QMainWindow
{
    Q_OBJECT
private:
...
public:
    explicit QTableWidgetMainWindow(QWidget *parent = nullptr);
    ~QTableWidgetMainWindow();

private:
    Ui::QTableWidgetMainWindow *ui;
};

#endif // QTABLEWIDGETMAINWINDOW_H
