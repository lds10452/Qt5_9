#include "CustomDelegateMainWindow.h"
#include "ui_CustomDelegateMainWindow.h"
#include    <QFileDialog>
#include    <QTextStream>


void CustomDelegateMainWindow::iniModelFromStringList(QStringList& aFileContent)
...
CustomDelegateMainWindow::CustomDelegateMainWindow(QWidget *parent) :
    QMainWindow(parent),
...
CustomDelegateMainWindow::~CustomDelegateMainWindow()
{
    delete ui;
}

void CustomDelegateMainWindow::on_currentChanged(const QModelIndex &current, const QModelIndex &previous)
{ //选择单元格变化时的响应
   Q_UNUSED(previous);
...
void CustomDelegateMainWindow::on_actOpen_triggered()
{ //打开文件
...
void CustomDelegateMainWindow::on_actAppend_triggered()
{ //在表格最后添加行
...
void CustomDelegateMainWindow::on_actInsert_triggered()
{//插入行
...
void CustomDelegateMainWindow::on_actDelete_triggered()
{ //删除行
...
void CustomDelegateMainWindow::on_actModelData_triggered()
...
void CustomDelegateMainWindow::on_actSave_triggered()
{ //保存为文件
    QString curPath=QCoreApplication::applicationDirPath(); //获取应用程序的路径
//调用打开文件对话框选择一个文件
...
void CustomDelegateMainWindow::on_actAlignCenter_triggered()
{//文字居中对齐
...
void CustomDelegateMainWindow::on_actFontBold_triggered(bool checked)
{//设置字体粗体
    if (!theSelection->hasSelection())
        return;
...
void CustomDelegateMainWindow::on_actAlignLeft_triggered()
{//设置文字居左对齐
...
void CustomDelegateMainWindow::on_actAlignRight_triggered()
{//设置文字居右对齐
    if (!theSelection->hasSelection())
        return;
