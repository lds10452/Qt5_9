#include "QStandardItemModelMainWindow.h"
#include "ui_QStandardItemModelMainWindow.h"
#include    <QFileDialog>
#include    <QTextStream>


void QStandardItemModelMainWindow::iniModelFromStringList(QStringList& aFileContent)
...
QStandardItemModelMainWindow::QStandardItemModelMainWindow(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::QStandardItemModelMainWindow)
{
    ui->setupUi(this);
...
QStandardItemModelMainWindow::~QStandardItemModelMainWindow()
{
    delete ui;
}

void QStandardItemModelMainWindow::on_currentChanged(const QModelIndex &current, const QModelIndex &previous)
{ //选择单元格变化时的响应
   Q_UNUSED(previous);
...
void QStandardItemModelMainWindow::on_actOpen_triggered()
{ //打开文件
    QString curPath=QCoreApplication::applicationDirPath(); //获取应用程序的路径
    curPath=curPath+"/../../bookDemo/res";
//调用打开文件对话框打开一个文件
...
void QStandardItemModelMainWindow::on_actAppend_triggered()
{ //在表格最后添加行
...
void QStandardItemModelMainWindow::on_actInsert_triggered()
{//插入行
...
void QStandardItemModelMainWindow::on_actDelete_triggered()
{ //删除行
...
void QStandardItemModelMainWindow::on_actModelData_triggered()
...
void QStandardItemModelMainWindow::on_actSave_triggered()
{ //保存为文件
    QString curPath=QCoreApplication::applicationDirPath(); //获取应用程序的路径
//调用打开文件对话框选择一个文件
...
void QStandardItemModelMainWindow::on_actAlignCenter_triggered()
{//文字居中对齐
...
void QStandardItemModelMainWindow::on_actFontBold_triggered(bool checked)
{//设置字体粗体
    if (!theSelection->hasSelection())
        return;
...
void QStandardItemModelMainWindow::on_actAlignLeft_triggered()
{//设置文字居左对齐
...
void QStandardItemModelMainWindow::on_actAlignRight_triggered()
{//设置文字居右对齐
    if (!theSelection->hasSelection())
        return;
