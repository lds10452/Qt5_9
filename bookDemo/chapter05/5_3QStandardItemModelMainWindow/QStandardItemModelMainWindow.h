#ifndef QSTANDARDITEMMODELMAINWINDOW_H
#define QSTANDARDITEMMODELMAINWINDOW_H
...
namespace Ui {
class QStandardItemModelMainWindow;
}

class QStandardItemModelMainWindow : public QMainWindow
{
    Q_OBJECT
private:
...
public:
    explicit QStandardItemModelMainWindow(QWidget *parent = nullptr);
    ~QStandardItemModelMainWindow();

private:
    Ui::QStandardItemModelMainWindow *ui;
};

#endif // QSTANDARDITEMMODELMAINWINDOW_H
