...
void PlotWidget::preparePoints(QRect &windRect)
{
    m_points.clear();
    int     xPos,yPos;
    qreal   x,y;
...
void PlotWidget::drawGrid(QPainter &p, QRect &windRect)
{
...
void PlotWidget::drawCurve(QPainter &p, QRect &windRect)
{
