#include "GraphicsCoordinateMainWindow.h"
#include "ui_GraphicsCoordinateMainWindow.h"
#include    <QGraphicsEllipseItem>

void GraphicsCoordinateMainWindow::iniGraphicsSystem()
{ //构造Graphics View的各项
...
void GraphicsCoordinateMainWindow::resizeEvent(QResizeEvent *event)
{ //窗口变化大小时的事件
    Q_UNUSED(event);
...
GraphicsCoordinateMainWindow::GraphicsCoordinateMainWindow(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::GraphicsCoordinateMainWindow)
{
    ui->setupUi(this);
...
GraphicsCoordinateMainWindow::~GraphicsCoordinateMainWindow()
{
    delete ui;
}

void GraphicsCoordinateMainWindow::on_mouseMovePoint(QPoint point)
...
void GraphicsCoordinateMainWindow::on_mouseClicked(QPoint point)
{//鼠标单击事件
    QPointF pointScene=ui->View->mapToScene(point); //转换到Scene坐标
