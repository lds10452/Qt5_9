#include "QPainterBasicWidget.h"
#include "ui_QPainterBasicWidget.h"

#include    <QPainter>

void QPainterBasicWidget::myDrawFilledRect()
{//基本绘图
...
void QPainterBasicWidget::myDrawTextureRect()
{
   QPainter    painter(this);//创建QPainter对象
   painter.setRenderHint(QPainter::Antialiasing);//
   painter.setRenderHint(QPainter::TextAntialiasing);//
...
void QPainterBasicWidget::myDrawGradient()
{
   QPainter    painter(this);//创建QPainter对象
   painter.setRenderHint(QPainter::Antialiasing);//
   painter.setRenderHint(QPainter::TextAntialiasing);//
...
void QPainterBasicWidget::total()
{
   QPainter    painter(this);//创建QPainter对象
   painter.setRenderHint(QPainter::Antialiasing);//
   painter.setRenderHint(QPainter::TextAntialiasing);//
...
void QPainterBasicWidget::myDrawShape()
{
   QPainter    painter(this);//创建QPainter对象
   painter.setRenderHint(QPainter::Antialiasing);
   painter.setRenderHint(QPainter::TextAntialiasing);
...
void QPainterBasicWidget::paintEvent(QPaintEvent *event)
{
// 1. 基本绘图1，绘制一个填充矩形
//   myDrawFilledRect();
...
QPainterBasicWidget::QPainterBasicWidget(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::QPainterBasicWidget)
{
    ui->setupUi(this);
...
QPainterBasicWidget::~QPainterBasicWidget()
{
    delete ui;
}
