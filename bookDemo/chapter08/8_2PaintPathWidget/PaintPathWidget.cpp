#include "PaintPathWidget.h"
#include "ui_PaintPathWidget.h"

#include    <QPainter>
#include    <QtMath>

void PaintPathWidget::paintEvent(QPaintEvent *event)
{
    Q_UNUSED(event);
...
PaintPathWidget::PaintPathWidget(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::PaintPathWidget)
{
    ui->setupUi(this);
...
PaintPathWidget::~PaintPathWidget()
{
    delete ui;
}
