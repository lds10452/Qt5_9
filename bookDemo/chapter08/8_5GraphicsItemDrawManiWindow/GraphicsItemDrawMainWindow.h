#ifndef GRAPHICSITEMDRAWMAINWINDOW_H
#define GRAPHICSITEMDRAWMAINWINDOW_H
...
namespace Ui {
class GraphicsItemDrawMainWindow;
}

class GraphicsItemDrawMainWindow : public QMainWindow
{
    Q_OBJECT
...
public:
    explicit GraphicsItemDrawMainWindow(QWidget *parent = nullptr);
    ~GraphicsItemDrawMainWindow();
...
private:
    Ui::GraphicsItemDrawMainWindow *ui;
};

#endif // GRAPHICSITEMDRAWMAINWINDOW_H
