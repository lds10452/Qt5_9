#ifndef BINFILEMAINWINDOW_H
#define BINFILEMAINWINDOW_H
...
#include    "../../chapter05/5_4CustomDelegateMainWindow/qwintspindelegate.h"
#include    "../../chapter05/5_4CustomDelegateMainWindow/qwfloatspindelegate.h"
#include    "../../chapter05/5_4CustomDelegateMainWindow/qwcomboboxdelegate.h"

#define     FixedColumnCount    6       //文件固定6行

namespace Ui {
class BinFileMainWindow;
}

class BinFileMainWindow : public QMainWindow
{
    Q_OBJECT
private:
...
public:
    explicit BinFileMainWindow(QWidget *parent = nullptr);
    ~BinFileMainWindow();
...
private:
    Ui::BinFileMainWindow *ui;
};

#endif // BINFILEMAINWINDOW_H
