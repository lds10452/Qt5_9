#include "DirFilesDialog.h"
#include "ui_DirFilesDialog.h"
...
void DirFilesDialog::showBtnInfo(QObject *btn)
{ //显示btn的信息
...
void DirFilesDialog::on_directoryChanged(const QString path)
{ //directoryChanged()信号的槽函数
    ui->plainTextEdit->appendPlainText(path);
    ui->plainTextEdit->appendPlainText("目录发生了变化\n");
}

void DirFilesDialog::on_fileChanged(const QString path)
{//fileChanged()信号的槽函数
    ui->plainTextEdit->appendPlainText(path);
    ui->plainTextEdit->appendPlainText("文件发生了变化\n");
}

DirFilesDialog::DirFilesDialog(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::DirFilesDialog)
{
    ui->setupUi(this);
    this->setWindowFlags(Qt::Window);
}

DirFilesDialog::~DirFilesDialog()
{
    delete ui;
}

void DirFilesDialog::on_pushButton_clicked()
{
    showBtnInfo(sender());
...
void DirFilesDialog::on_pushButton_2_clicked()
{
    showBtnInfo(sender());
...
void DirFilesDialog::on_pushButton_3_clicked()
{
    showBtnInfo(sender());
...
void DirFilesDialog::on_pushButton_4_clicked()
{
    showBtnInfo(sender());
...
void DirFilesDialog::on_pushButton_5_clicked()
{
    ui->plainTextEdit->clear();
}


void DirFilesDialog::on_pushButton_41_clicked()
{//打开文件
...
void DirFilesDialog::on_pushButton_45_clicked()
{
    QString curDir=QDir::currentPath();
...
void DirFilesDialog::on_pushButton_28_clicked()
...
void DirFilesDialog::on_pushButton_29_clicked()
...
void DirFilesDialog::on_pushButton_30_clicked()
{//QFileInfo.basename()
    showBtnInfo(sender());
    QFileInfo  fileInfo(ui->editFile->text());
...
void DirFilesDialog::on_pushButton_31_clicked()
{
    showBtnInfo(sender());
    QFileInfo  fileInfo(ui->editFile->text());
...
void DirFilesDialog::on_pushButton_32_clicked()
{
    showBtnInfo(sender());
    QFileInfo  fileInfo(ui->editFile->text());
...
void DirFilesDialog::on_pushButton_27_clicked()
{
    showBtnInfo(sender());
    QFileInfo  fileInfo(ui->editFile->text());
...
void DirFilesDialog::on_pushButton_39_clicked()
{
    showBtnInfo(sender());
    QFileInfo  fileInfo(ui->editFile->text());
...
void DirFilesDialog::on_pushButton_33_clicked()
{
    showBtnInfo(sender());
    QFileInfo  fileInfo(ui->editFile->text());
...
void DirFilesDialog::on_pushButton_34_clicked()
{
    showBtnInfo(sender());
    QFileInfo  fileInfo(ui->editFile->text());
...
void DirFilesDialog::on_pushButton_42_clicked()
{
    showBtnInfo(sender());
...
void DirFilesDialog::on_pushButton_43_clicked()
{
    showBtnInfo(sender());
    QFileInfo  fileInfo(ui->editFile->text());
...
void DirFilesDialog::on_pushButton_35_clicked()
{
    showBtnInfo(sender());
    QFileInfo  fileInfo(ui->editFile->text());
...
void DirFilesDialog::on_pushButton_37_clicked()
{
    showBtnInfo(sender());
    QFileInfo  fileInfo(ui->editFile->text());
...
void DirFilesDialog::on_pushButton_36_clicked()
{
    showBtnInfo(sender());
    QFileInfo  fileInfo(ui->editFile->text());
...
void DirFilesDialog::on_pushButton_44_clicked()
{
    showBtnInfo(sender());
    QFileInfo  fileInfo(ui->editFile->text());
...
void DirFilesDialog::on_pushButton_38_clicked()
{
    showBtnInfo(sender());
    QFileInfo  fileInfo(ui->editFile->text());
...
void DirFilesDialog::on_pushButton_10_clicked()
{
    showBtnInfo(sender());
...
void DirFilesDialog::on_pushButton_9_clicked()
{
    showBtnInfo(sender());
...
void DirFilesDialog::on_pushButton_8_clicked()
{
    showBtnInfo(sender());
...
void DirFilesDialog::on_pushButton_6_clicked()
{
    showBtnInfo(sender());
...
void DirFilesDialog::on_pushButton_7_clicked()
{
    showBtnInfo(sender());
...
void DirFilesDialog::on_pushButton_13_clicked()
{//absoluteFilePath()，
    showBtnInfo(sender());
...
void DirFilesDialog::on_pushButton_14_clicked()
{
    showBtnInfo(sender());
    QDir    dir(ui->editDir->text());
...
void DirFilesDialog::on_pushButton_15_clicked()
{
    showBtnInfo(sender());
    QDir    dir(ui->editDir->text());
...
void DirFilesDialog::on_pushButton_19_clicked()
{
    showBtnInfo(sender());
    QDir    dir(ui->editDir->text());
...
void DirFilesDialog::on_pushButton_16_clicked()
{
    showBtnInfo(sender());
    QDir    dir(ui->editDir->text());
...
void DirFilesDialog::on_pushButton_18_clicked()
{
    showBtnInfo(sender());
    QDir    dir(ui->editDir->text());
    bool  the=dir.exists();
...
void DirFilesDialog::on_pushButton_17_clicked()
{//列出所有文件
    showBtnInfo(sender());
    QDir    dir(ui->editDir->text());
...
void DirFilesDialog::on_pushButton_11_clicked()
{//列出子目录
    showBtnInfo(sender());
...
void DirFilesDialog::on_pushButton_24_clicked()
{
    showBtnInfo(sender());
...
void DirFilesDialog::on_pushButton_20_clicked()
{
    showBtnInfo(sender());
...
void DirFilesDialog::on_pushButton_26_clicked()
{
    showBtnInfo(sender());
    QString curDir=QDir::currentPath();
    QDir    lastDir(curDir);
...
void DirFilesDialog::on_pushButton_22_clicked()
{
    showBtnInfo(sender());
    QDir    dir(ui->editDir->text());
...
void DirFilesDialog::on_pushButton_12_clicked()
{
    showBtnInfo(sender());
    QDir    dir(ui->editDir->text());
...
void DirFilesDialog::on_pushButton_23_clicked()
{
    showBtnInfo(sender());
...
void DirFilesDialog::on_pushButton_21_clicked()
{//QTemporaryDir
    showBtnInfo(sender());
...
void DirFilesDialog::on_pushButton_25_clicked()
{//QTemporaryFile
    showBtnInfo(sender());
...
void DirFilesDialog::on_pushButton_40_clicked()
{
    QCoreApplication::exit();
}

void DirFilesDialog::on_pushButton_48_clicked()
{
    showBtnInfo(sender());
    QString sous=ui->editFile->text(); //源文件
    QFileInfo   fileInfo(sous);//
...
void DirFilesDialog::on_pushButton_51_clicked()
{
    showBtnInfo(sender());
    QString sous=ui->editFile->text(); //源文件
...
void DirFilesDialog::on_pushButton_54_clicked()
{
    showBtnInfo(sender());
    QString sous=ui->editFile->text(); //源文件
    QFile   file(sous);
...
void DirFilesDialog::on_pushButton_53_clicked()
{
    showBtnInfo(sender());
    QString sous=ui->editFile->text(); //源文件
    QFile   file(sous);
...
void DirFilesDialog::on_pushButton_49_clicked()
{
    showBtnInfo(sender());
    QString sous=ui->editFile->text(); //源文件
    QFile::remove(sous);
...
void DirFilesDialog::on_pushButton_50_clicked()
{//QFile::rename()
    showBtnInfo(sender());
    QString sous=ui->editFile->text(); //源文件
...
void DirFilesDialog::on_pushButton_55_clicked()
{
    showBtnInfo(sender());
    QString sous=ui->editFile->text(); //源文件
    QFile   file(sous);
...
void DirFilesDialog::on_pushButton_56_clicked()
{//QFile.rename()
    showBtnInfo(sender());
    QString sous=ui->editFile->text(); //源文件
...
void DirFilesDialog::on_pushButton_46_clicked()
{//开始监听,addPath()
    showBtnInfo(sender());
    ...
    QObject::connect(&fileWatcher,&QFileSystemWatcher::directoryChanged,
            this,&DirFilesDialog::on_directoryChanged); //directoryChanged
    QObject::connect(&fileWatcher,&QFileSystemWatcher::fileChanged,
            this,&DirFilesDialog::on_fileChanged); //fileChanged
}

void DirFilesDialog::on_pushButton_47_clicked()
{//停止监听,removePath()
    showBtnInfo(sender());
...
void DirFilesDialog::on_pushButton_52_clicked()
{//显示监听目录,directories()
    showBtnInfo(sender());
...
void DirFilesDialog::on_pushButton_57_clicked()
{//显示监听文件,files()
    showBtnInfo(sender());
...
void DirFilesDialog::on_pushButton_59_clicked()
{
    showBtnInfo(sender());
...
void DirFilesDialog::on_pushButton_58_clicked()
{
    showBtnInfo(sender());
    QFileInfo  fileInfo(ui->editFile->text());
...
void DirFilesDialog::on_pushButton_60_clicked()
{
    showBtnInfo(sender());
...
void DirFilesDialog::on_pushButton_61_clicked()
{
   showBtnInfo(sender());
